    ...
    to measure and detect the distance from the kiosk and the surrounding temperature, which is displayed prominently on the LCD screen to provide real-time environmental information.
    */
